...
utilizando localStorage.getItem, modificando o 
valor de `string` com JSON.parse()*/
...
function criaElemento(item) {
    ...
    novoItem.innerHTML += item.nome //recebendo item da camisa branca no html
...
function botaoDeleta(id) {
    ...
    elementoBotao.addEventListener("click", function () {
        deletaElelemento(this.parentNode, id)
    })

    return elementoBotao
}

function deletaElelemento(tag, id) {
    tag.remove()
    console.log(id)
